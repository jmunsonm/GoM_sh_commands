...
megacc -a /mnt/scgc/simon/microg2p/analyses/20210325_GoM_recluster/20210325_GoM_recluster_analysis/aprA/infer_ML_amino_acid.mao -d  -o megacc_tree_/aprA_assi_tree -f fasta
